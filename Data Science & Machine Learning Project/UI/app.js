    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            data = [
                {
                    class: "viral_kohli",
                    class_probability: [1.05, 12.67, 4.5, 91.56],
                    class_dictionary: {
                        lionel_messi: 0,
                        maria_sharapova: 1,
                        serena_williams: 2,
                ...
                {
                    class: "serena_williams",
                    class_probability: [7.02, 23.7, 52.00, 1.62],
                    class_dictionary: {
                        lionel_messi: 0,
                        maria_sharapova: 1,
                        serena_williams: 2,
            ...
            */
            ...
            /*let players = ["lionel_messi", "maria_sharapova","serena_williams", "virat_kohli"];*/
